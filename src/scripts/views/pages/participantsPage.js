        ...
        <section class="mx-auto pb-40">
          ...
          <table id="table-id" class="sortable mx-auto text-base table-fix w-full pt-2 px-2">
              ...
              <tr>
                  ...
                  <th class="bg-white">Tipe Tiket</th>
